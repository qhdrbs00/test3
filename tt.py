...
''
'## :orange[자기 소개]'
'안녕하세요 제 이름은 서봉균이고, 21살입니다. 끊임없이 도전하고 성장하는 것을 좋아하며, 새로운 경험을 통해 스스로 발전하는 것을 좋아하며, 새로운 경험을 통해 스스로 발전하는 것을 목표로 삼고 있습니다. 지금까지의 경험과 미래의 목표를 기반으로 소개합니다'
'1.학력 및 전공'
'건양대학교 재난안전소방학과에서 소방학을 전공 했습니다. 소방학을 전공하긴 했지만 재난과 안전도 주로 배웠기 때문에 여러가지 안전 상황에서 다양한 분석과 해결 능력을 갖춘 다양한 상황에서 활용될 수 있습니다. '
'2.경력 및 프로젝트'
'건양대학교 캡스톤 디자인을 통해 전기자동차 화재 시 탑습자의 인명 안전을 위한 사출 장치 라는 논문을 팀원과 작성하고 실제로 모형으로 제작하여 사출되는 현장을 구축했습니다. 팀 프로젝트 에서 팀원들과 원활한 소통과 협력을 통해 성공으로 프로젝트를 완료 했습니다.'
'3.기술 및 능력'
'위험물 산업 기사 자격증을 보유하고 있습니다. 이 자격증으로 인해 보다 안전한 산업 현장을 구축 할 수 있고 컴퓨터 활용 자격증 1급으로 인해 현장 뿐만 아니라 사무 능력까지 겸비할 수 있습니다.'
'4.팀워크 및 공모전'
'2023 지역사회 문제해결 소셜번체 해커톤 연합 캠프에서 팀장으로 팀원들과 원활한 커뮤니케이션과 협력을 통해 팀의 목표를 달성하여 대상을 수사안 기록이 있습니다.'
'5.목표와 포부 '
